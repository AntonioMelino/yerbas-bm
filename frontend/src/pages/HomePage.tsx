    ...
    <div className="bg-ink">
      ...
      <section id="inicio" className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-5 sm:px-8 pt-28 pb-20 w-full">
          <p className="animate-fade-up animation-delay-100 text-lime uppercase eyebrow text-xs sm:text-sm mb-6">
            Yerba mate · Mates · Accesorios
          </p>
          <h1 className="animate-fade-up animation-delay-250 font-display font-bold text-4xl sm:text-6xl lg:text-7xl leading-[1.08] max-w-3xl text-cream">
            El ritual del mate,
            <br />
            <span className="text-lime">en cada detalle</span>
          </h1>
          <p className="animate-fade-up animation-delay-400 mt-7 max-w-xl text-cream/75 text-base sm:text-lg font-light leading-relaxed">
            Yerbas seleccionadas, mates artesanales y todo lo que necesitás para cebar como se debe.
            Tradición gaucha, directo a tu casa.
          </p>
          <div className="animate-fade-up animation-delay-550 mt-10 flex flex-wrap gap-4">
            <Link
              to="/productos"
              className="bg-lime text-ink font-semibold px-8 py-3.5 rounded-full hover:bg-gold hover:text-cream transition-all duration-300 shadow-lg shadow-lime/20"
            >
              Ver catálogo
            </Link>
            <a
              ...
              className="flex items-center gap-2 border border-cream/30 hover:border-wa text-cream px-8 py-3.5 rounded-full transition-all duration-300 backdrop-blur-sm bg-ink/30"
            >
      ...
      {/* Destacados */}
      <section id="destacados" className="max-w-7xl mx-auto px-5 sm:px-8 pb-24">
      ...
      {/* Nosotros */}
      <section id="nosotros" className="relative py-24 bg-night border-y border-olive/40 overflow-hidden">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 grid lg:grid-cols-2 gap-14 items-center">
          <div className="img-zoom rounded-2xl overflow-hidden border border-olive/50 shadow-2xl rotate-[-1.5deg]">
            <img
          ...
          <div>
            ...
            <h2 className="font-display font-bold text-3xl sm:text-4xl leading-snug mb-6 text-cream">
              Hecho con las manos,
              <br />
            ...
            <div className="flex gap-10">
              <div>
                <p className="font-display text-3xl text-lime font-bold">100%</p>
                <p className="text-xs uppercase tracking-widest text-cream/50 mt-1">Artesanal</p>
              </div>
              <div>
                <p className="font-display text-3xl text-lime font-bold">+500</p>
                <p className="text-xs uppercase tracking-widest text-cream/50 mt-1">Mates cebados</p>
              </div>
              <div>
                <p className="font-display text-3xl text-lime font-bold">24h</p>
                <p className="text-xs uppercase tracking-widest text-cream/50 mt-1">Envío CABA</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative text-center max-w-2xl mx-auto px-5">
          <h2 className="font-display font-bold text-3xl sm:text-4xl mb-5 text-cream">
          ...
          <button
            type="button"
            onClick={openCart}
            className="bg-wa text-ink font-bold px-9 py-4 rounded-full hover:brightness-110 transition shadow-xl shadow-wa/25 inline-flex items-center gap-2.5"
          >
            <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
              <path d="M17.5 14.4c-.3-.15-1.76-.87-2.03-.97-.27-.1-.47-.15-.67.15-.2.3-.77.97-.94 1.17-.17.2-.35.22-.65.07-.3-.15-1.26-.46-2.4-1.48-.89-.79-1.49-1.77-1.66-2.07-.17-.3-.02-.46.13-.61.13-.13.3-.35.45-.52.15-.17.2-.3.3-.5.1-.2.05-.37-.02-.52-.07-.15-.67-1.62-.92-2.22-.24-.58-.49-.5-.67-.51h-.57c-.2 0-.52.07-.8.37-.27.3-1.04 1.02-1.04 2.5 0 1.47 1.07 2.9 1.22 3.1.15.2 2.11 3.22 5.1 4.51.71.31 1.27.49 1.7.63.72.23 1.37.2 1.88.12.57-.09 1.76-.72 2.01-1.42.25-.7.25-1.3.17-1.42-.07-.12-.27-.2-.57-.35M12.05 21.8h-.01a9.87 9.87 0 01-5.03-1.38l-.36-.21-3.74.98 1-3.65-.24-.37a9.83 9.83 0 01-1.51-5.26c0-5.45 4.44-9.88 9.9-9.88a9.83 9.83 0 016.99 2.9 9.82 9.82 0 012.9 7c0 5.45-4.45 9.87-9.9 9.87m8.42-18.3A11.8 11.8 0 0012.04 0C5.5 0 .16 5.34.16 11.9c0 2.1.55 4.14 1.59 5.95L.06 24l6.3-1.65a11.9 11.9 0 005.68 1.44h.01c6.55 0 11.89-5.33 11.89-11.9 0-3.18-1.24-6.16-3.47-8.4" />
            </svg>
